...
public class ServiciuBazaDeDate extends Thread {
    private static ServiciuBazaDeDate singleInstance=null;
    private Connection myConn;

    public ServiciuBazaDeDate() throws SQLException {
        myConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?autoReconnect=true", "root", "root");
    }

    public static ServiciuBazaDeDate getInstance() throws SQLException {
        if (singleInstance == null)
            singleInstance = new ServiciuBazaDeDate();
